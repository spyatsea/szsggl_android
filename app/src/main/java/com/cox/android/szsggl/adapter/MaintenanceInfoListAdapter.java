...
public class MaintenanceInfoListAdapter extends BaseAdapter implements Filterable {
    ...
    public MaintenanceInfoListAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
        mData = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 普通信息
        mDropDownResource = R.layout.maintenance_info_list_item;
        view = createViewFromResource(position, convertView, parent, R.layout.maintenance_info_list_item);
        convertView = view;
