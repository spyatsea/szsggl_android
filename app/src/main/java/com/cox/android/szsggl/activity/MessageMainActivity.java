...
import com.cox.android.ui.MessageViewPager;
...
public class MessageMainActivity extends DbActivity {
    /**
     * 当前类对象
     * */
     ...
     * 按钮：信息服务
     */
    private Button nav_btn_news;
    /**
     * 按钮：消息中心
     */
    private RadioButton nav_btn_message;
    /**
     * 按钮：设置
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classThis = MessageMainActivity.this;
        ...
        // 界面相关参数。开始===============================
        nav_btn_news = (Button) findViewById(R.id.nav_btn_news);
        nav_btn_message = (RadioButton) findViewById(R.id.nav_btn_message);
        nav_btn_config = (Button) findViewById(R.id.nav_btn_config);

        // 显示等待窗口
        makeWaitDialog();
        titleBarName.setText(R.string.title_message);
        nav_btn_news.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                // 创建启动 Activity 的 Intent
//				Intent intent = new Intent(classThis, NewsMainActivity.class);
//				// 信息传输Bundle
...
//				overridePendingTransition(R.anim.activity_slide_left_in, R.anim.activity_slide_left_out);
        ...
        nav_btn_message.setOnClickListener(new OnClickListener() {
        ...
        // 获取ViewPager
        viewPager = (MessageViewPager) findViewById(R.id.viewpager);
        ...
        for (int i = 0, len = channelList.size(); i < len; i++) {
            pagerAdapter.addTab(actionBar.newTab().setText((String) channelList.get(i).get("title")),
                    MessageChannelT1Fragment.class, null);
        }
        actionBar.hide();
    }
