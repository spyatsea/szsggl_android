 ...
 */
public class ShowImageReverseLandActivity extends DbActivity {
    /**
     * 当前类对象
     * */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        classThis = ShowImageReverseLandActivity.this;
    ...
    private class MainTask extends AsyncTask<Object, Integer, String> {
        ...
        protected void onProgressUpdate(Integer... progress) {
            if (progress[0] == PROGRESS_SET_FIELD) {
                ...
                if (file.exists()) {
                    // 图片文件存在
                    bm = CommonUtil.decodeSampledBitmapFromResource(filepath, CommonParam.SHOW_IMAGE_HEIGHT,
                            CommonParam.SHOW_IMAGE_WIDTH);
                } else {
                    // 图片文件不存在
