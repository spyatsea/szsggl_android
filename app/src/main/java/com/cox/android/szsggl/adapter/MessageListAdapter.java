...
public class MessageListAdapter extends BaseAdapter implements Filterable {
	...
	public int getItemViewType(int position) {
		...
		if (CommonParam.MESSAGE_INFO_TYPE_NORMAL.equals(insInfoType)) {
			// 普通信息
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (currentType == TYPE_NORMAL) {
			// 普通信息
			mDropDownResource = R.layout.message_t1_list_normal_item;
			view = createViewFromResource(position, convertView, parent, R.layout.message_t1_list_normal_item);
			convertView = view;
		}
