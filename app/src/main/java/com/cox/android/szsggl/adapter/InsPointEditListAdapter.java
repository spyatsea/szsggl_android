...
public class InsPointEditListAdapter extends BaseAdapter implements Filterable {
    ...
    public InsPointEditListAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
        mData = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 普通信息
        mDropDownResource = R.layout.ins_point_edit_list_item;
        view = createViewFromResource(position, convertView, parent, R.layout.ins_point_edit_list_item);
        convertView = view;
