...
public class CommonParam {
	...
	// 测试
	// public static final String BAIDU_SECRET_KEY = "DHqloKev8fS0Z2WepjZHVDNpUTUb2clG";
	// 发布
	public static final String BAIDU_SECRET_KEY = "iFnRyZFl1Fiwfoso86hhfsL9L22pxoRz";
	 ...
	 * URL：上传巡视附件
	 * */
	public static final String URL_UPLOAD_INS_ATTACHMENT = "fileUp_upload_sgins_attachfile.action";
	/**
	 * URL指令：完成上传巡检信息
	 * */
	public static final String URLCOMMAND_FINISH_UP_INS = "finishupins";
	// URL常量。开始=======================================================
	public static final String URL_SEARCHTABLE = "ss_searchtable.action";
	public static final String URL_EXECSQL = "ss_execsql.action";
	public static final String URL_COMMAND = "ss_command.action";
	public static final String URL_CHANGEUSERPWD = "ss_changeuserpwd.action";
	public static final String URL_CHECKUPDATE = "ss_checkupdate.action";
	public static final String URL_CHECKUSER = "ss_checkuser.action";
	public static final String URL_CHECKUSERDETAIL = "ss_checkuserdetail.action";
	public static final String URL_SUBMITINFO = "ss_submitinfo.action";
	public static final String URL_PRIVACY = "privacy.html";

	public static final String URL_SAVEINFO = "ss_saveinfo.action";
	public static final String URL_GETNEWSINFOLIST = "ss_getnewsinfolist.action";
